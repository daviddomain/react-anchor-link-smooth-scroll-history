...
var _anchorLink = __webpack_require__(3);
...
var AnchorLink = function (_Component) {
  ...
  _createClass(AnchorLink, [{
    ...
    value: function smoothScroll(e) {
      e.preventDefault();
      var offset = this.props.offset ? this.getOffset(this.props.offset) : 0;
      var id = e.target.hasAttribute('href') ? e.target.getAttribute('href').slice(1) : e.target.dataset.href.slice(1);
      window.scroll({
